...
Текущий функционал. Можно перетащить файл drl в окно программы. Работает скролл и перемещение средней кнопкой мышки. Отображаются лишь контуры отверстий.
Текущая версия GiCad 0.0.0.3. Релиз выйдет как дотикает до тысячи. То есть, чуть раньше, чем никогда.
...
![GiCad](https://github.com/mikelsv/GiCad/blob/main/screenshot/gicad%200.0.0.3.jpg)
