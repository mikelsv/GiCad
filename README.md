...
Текущая версия GiCad 0.0.0.7. Релиз выйдет как дотикает до тысячи. То есть, чуть раньше, чем никогда.
...
![GiCad](https://github.com/mikelsv/GiCad/blob/main/screenshot/gicad%200.0.0.7.jpg)
